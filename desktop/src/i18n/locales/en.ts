export const en = {
  ...
  'empty.starter.explore': 'Explore and understand code',
  'empty.starter.explorePrompt': 'Explore this codebase and explain its architecture.',
  'empty.starter.build': 'Build a feature, app, or tool',
  'empty.starter.buildPrompt': 'Help me build a new feature for this project.',
  'empty.starter.review': 'Review code and suggest improvements',
  'empty.starter.reviewPrompt': 'Review the current code and suggest focused improvements.',
  'empty.starter.fix': 'Fix bugs and failures',
  'empty.starter.fixPrompt': 'Find and fix the most important bug in this project.',
